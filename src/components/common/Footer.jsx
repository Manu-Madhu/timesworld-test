...
const Footer = () => {
  return (
    <main className="common-container px-4 px-md-3 mt-5 h-50 d-flex flex-column align-items-center">
      {/* Icons */}
      <section className="d-flex align-items-center justify-content-center gap-2 gap-md-3 mt-3 mt-md-5 pt-md-5">
